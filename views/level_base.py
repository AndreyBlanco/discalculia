...
Proporciona funcionalidad común como dibujo de HUD, transiciones, y feedback.
"""
...
class Gem:
    ...
    def draw(self):
        ...
        arcade.draw_ellipse_filled(
            self.x + 2, self.y - actual_size * 0.5, actual_size * 0.8, actual_size * 0.2,
            (0, 0, 0, 30)
        )

        # Cuerpo de la gema (diamante)
        points = [
...
class AnswerButton:
    """Botón de respuesta para los niveles."""
...
class LevelBase(arcade.View):
    ...
    def draw_feedback(self):
        """Dibuja el feedback visual después de una respuesta."""
        if self.state == "feedback":
            # Calcular tamaño del panel según contenido
    ...
    def update_feedback(self, delta_time):
        """Actualiza el temporizador de feedback."""
        if self.state == "feedback":
    ...
    def setup_trial(self):
        """Configura el siguiente intento. Debe ser implementado por las subclases."""
        pass

    def go_to_next_level(self):
        """Avanza al siguiente nivel o muestra el reporte."""
